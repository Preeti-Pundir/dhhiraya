    ...
    <div class="container ">
        ...
        <div class="row">
            <div class="col-md-4 pt-5 pb-5">
                <!-- Tabs nav -->
                <div class="nav flex-column myaccount-tabs nav-pills nav-pills-custom" id="v-pills-tab" role="tablist"
                    aria-orientation="vertical">
                    <a class="nav-link mb-5 p-3 shadow active" id="v-pills-saved-properties-tab" data-toggle="pill"
                    ...
                    <a class="nav-link mb-5 p-3 shadow" id="v-pills-visited-properties-tab" data-toggle="pill"
                    ...
                    <a class="nav-link mb-5 p-3 shadow" id="v-pills-faqs-tab" data-toggle="pill" href="#v-pills-faqs"
                        role="tab" aria-controls="v-pills-faqs" aria-selected="false">
                        <span class="font-weight-bold small text-uppercase">FAQs</span></a>

                    <a class="nav-link mb-5 p-3 shadow" id="v-pills-terms-tab" data-toggle="pill" href="#v-pills-terms"
            ...
            <div class="col-md-8">
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade shadow rounded bg-white show active p-5" id="v-pills-saved-properties"
                    ...
                    <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-visited-properties"
                    ...
                    <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-faqs" role="tabpanel"
                    ...
                    <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-terms" role="tabpanel"
