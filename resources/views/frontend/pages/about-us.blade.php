...
<div class="container-fluid  mt-5">
    <div class="row text-center about-first-row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6  my-2 "><img src="/frontend/img/about-img2.png" alt="" width="100%"
                style="height:250px"></div>
...
<div class="container pt-5 pb-5">
    <div class="row">
        <div class="col-md-5 my-3"><img src="/frontend/img/Rectangle 50.png" alt="" width="100%" style="height:200px">
        </div>
        <div class="col-md-3 my-3"><img src="/frontend/img/Rectangle 52.png" alt="" width="100%" style="height:200px">
        </div>
        <div class="col-md-4 my-3"><img src="/frontend/img/Rectangle 51.png" alt="" width="100%" style="height:200px">
        </div>
    </div>
</div>
