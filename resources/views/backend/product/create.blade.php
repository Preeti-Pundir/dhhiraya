        ...
        <div class="card-body">
            <form method="post" action="{{ route('product.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="brochure"  value="{{ old('brochure') }}" class="form-control">
                    @error('brochure')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="inputTitle" type="text" name="developersite" placeholder="https://example.com"
                        value="{{ old('developersite') }}" class="form-control">
                    @error('developersite')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="developer" name="developer">{{ old('developer') }}</textarea>
                    @error('developer')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="acquisition" name="acquisition">{{ old('acquisition') }}</textarea>
                    @error('acquisition')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="inputrooms" type="text" name="rooms" placeholder="Enter rooms"
                        value="{{ old('rooms') }}" class="form-control">
                    @error('rooms')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
